<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Updating.aspx.cs" Inherits="SellCar.Updating" %>
...
<body>
    ...
    <main style="height: 100vh; display: flex; justify-content: center; align-items: center;">
        <div style="font-size:20px; font-weight:bold;">Tính năng này đang được cập nhật</div>
    </main>
    <footer>
